...
import manufacturingSystem.util.ManufacturingSystemValidator;
...
public class ManufacturingSystemPackageImpl extends EPackageImpl implements ManufacturingSystemPackage {
	...
	public static ManufacturingSystemPackage init() {
		...
		EValidator.Registry.INSTANCE.put
			(theManufacturingSystemPackage,
			 new EValidator.Descriptor() {
				 public EValidator getEValidator() {
					 return ManufacturingSystemValidator.INSTANCE;
				 }
			 });
	 ...
	 * @generated
	 */
	public EOperation getManufacturingSystem__NoInTransition__DiagnosticChain_Map() {
		return manufacturingSystemEClass.getEOperations().get(0);
	}
	 ...
	 * @generated
	 */
	public EOperation getManufacturingSystem__NotTheSame__DiagnosticChain_Map() {
		return manufacturingSystemEClass.getEOperations().get(1);
	}
	 ...
	 * @generated
	 */
	public EOperation getManufacturingSystem__NoOutTransition__DiagnosticChain_Map() {
		return manufacturingSystemEClass.getEOperations().get(2);
	}
	 ...
	 * @generated
	 */
	public EOperation getStep__MustOneResponsible__DiagnosticChain_Map() {
	 ...
	 * @generated
	 */
	public EOperation getResponsible__LessThanThreeStep__DiagnosticChain_Map() {
		return responsibleEClass.getEOperations().get(0);
	}
	 ...
	 * @generated
	 */
	public EOperation getResponsible__MoreThanOneStep__DiagnosticChain_Map() {
		return responsibleEClass.getEOperations().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEOperation(manufacturingSystemEClass, MANUFACTURING_SYSTEM___NO_IN_TRANSITION__DIAGNOSTICCHAIN_MAP);
		createEOperation(manufacturingSystemEClass, MANUFACTURING_SYSTEM___NOT_THE_SAME__DIAGNOSTICCHAIN_MAP);
		createEOperation(manufacturingSystemEClass, MANUFACTURING_SYSTEM___NO_OUT_TRANSITION__DIAGNOSTICCHAIN_MAP);
		...
		createEOperation(stepEClass, STEP___MUST_ONE_RESPONSIBLE__DIAGNOSTICCHAIN_MAP);

		responsibleEClass = createEClass(RESPONSIBLE);
		createEAttribute(responsibleEClass, RESPONSIBLE__NAME);
		createEOperation(responsibleEClass, RESPONSIBLE___LESS_THAN_THREE_STEP__DIAGNOSTICCHAIN_MAP);
		createEOperation(responsibleEClass, RESPONSIBLE___MORE_THAN_ONE_STEP__DIAGNOSTICCHAIN_MAP);
	...
	public void initializePackageContents() {
		...
		EOperation op = initEOperation(getManufacturingSystem__NoInTransition__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "NoInTransition", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = initEOperation(getManufacturingSystem__NotTheSame__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "NotTheSame", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = initEOperation(getManufacturingSystem__NoOutTransition__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "NoOutTransition", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		initEAttribute(getStep_Speed(), ecorePackage.getEInt(), "speed", "0", 1, 1, Step.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		op = initEOperation(getStep__MustOneResponsible__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "MustOneResponsible", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = initEOperation(getResponsible__LessThanThreeStep__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "LessThanThreeStep", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = initEOperation(getResponsible__MoreThanOneStep__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "MoreThanOneStep", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation
		  (manufacturingSystemEClass,
		   source,
		   new String[] {
			   "constraints", "NoOutTransition"
		   });
		addAnnotation
		  (stepEClass,
		   source,
		   new String[] {
			   "constraints", "MustOneResponsible"
		   });
		addAnnotation
		  (responsibleEClass,
		   source,
		   new String[] {
			   "constraints", "MoreThanOneStep"
		   });
	}
	...
	protected void createPivotAnnotations() {
		...
		addAnnotation
		  (getManufacturingSystem__NoInTransition__DiagnosticChain_Map(),
		   source,
		   new String[] {
			   "body", "not self.consistsOf.transition->includes(self.start)"
		   });
		addAnnotation
		  (getManufacturingSystem__NotTheSame__DiagnosticChain_Map(),
		   source,
		   new String[] {
			   "body", "not self.consistsOf.responsible->includes(self.responsible) "
		   });
		addAnnotation
		  (getManufacturingSystem__NoOutTransition__DiagnosticChain_Map(),
		   source,
		   new String[] {
			   "body", "self.end.transition -> size() = 0"
		   });
		addAnnotation
		  (getStep__MustOneResponsible__DiagnosticChain_Map(),
		   source,
		   new String[] {
			   "body", "self.responsible->size() = 1 "
		   });
		addAnnotation
		  (getResponsible__LessThanThreeStep__DiagnosticChain_Map(),
		   source,
		   new String[] {
			   "body", "Step.allInstances()->select(responsible=self) -> size() <= 3"
		   });
		addAnnotation
		  (getResponsible__MoreThanOneStep__DiagnosticChain_Map(),
		   source,
		   new String[] {
			   "body", "Step.allInstances()->select(responsible=self) -> size() >= 1"
		   });
	}
