 ...
 * @model annotation="http://www.eclipse.org/emf/2002/Ecore constraints='NoOutTransition'"
 * @generated
 */
public interface ManufacturingSystem extends EObject {
	 ...
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @model annotation="http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot body='not self.consistsOf.transition-&gt;includes(self.start)'"
	 * @generated
	 */
	boolean NoInTransition(DiagnosticChain diagnostics, Map<Object, Object> context);

	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @model annotation="http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot body='not self.consistsOf.responsible-&gt;includes(self.responsible) '"
	 * @generated
	 */
	boolean NotTheSame(DiagnosticChain diagnostics, Map<Object, Object> context);

	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @model annotation="http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot body='self.end.transition -&gt; size() = 0'"
	 * @generated
	 */
	boolean NoOutTransition(DiagnosticChain diagnostics, Map<Object, Object> context);
