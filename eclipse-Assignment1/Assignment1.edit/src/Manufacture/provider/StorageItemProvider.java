...
/**
 * This is the item provider adapter for a {@link Manufacture.Storage} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StorageItemProvider extends ElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Storage_stores_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Storage_stores_feature", "_UI_Storage_type"),
				 ManufacturePackage.Literals.STORAGE__STORES,
				 true,
				 false,
				 true,
				 null,
