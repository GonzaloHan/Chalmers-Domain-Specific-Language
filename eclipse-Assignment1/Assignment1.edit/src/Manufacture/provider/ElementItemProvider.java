...
/**
 * This is the item provider adapter for a {@link Manufacture.Element} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ManufacturePackage.Literals.ELEMENT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addResponsiblePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Element_responsible_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Element_responsible_feature", "_UI_Element_type"),
				 ManufacturePackage.Literals.ELEMENT__RESPONSIBLE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addMovePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Element_move_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Element_move_feature", "_UI_Element_type"),
				 ManufacturePackage.Literals.ELEMENT__MOVE,
				 true,
				 false,
				 true,
				 null,
