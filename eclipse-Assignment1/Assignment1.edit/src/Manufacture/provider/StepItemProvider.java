...
/**
 * This is the item provider adapter for a {@link Manufacture.Step} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Step_speed_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Step_speed_feature", "_UI_Step_type"),
				 ManufacturePackage.Literals.STEP__SPEED,
				 true,
				 false,
				 false,
	...
	protected void addInputPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Step_input_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Step_input_feature", "_UI_Step_type"),
				 ManufacturePackage.Literals.STEP__INPUT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addOutputPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Step_output_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Step_output_feature", "_UI_Step_type"),
				 ManufacturePackage.Literals.STEP__OUTPUT,
				 true,
				 false,
				 true,
				 null,
