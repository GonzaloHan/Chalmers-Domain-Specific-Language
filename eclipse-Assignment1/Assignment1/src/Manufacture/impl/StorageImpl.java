 ...
 * </p>
 * <ul>
 *   <li>{@link Manufacture.impl.StorageImpl#getStores <em>Stores</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StorageImpl extends ElementImpl implements Storage {
	...
	public EList<WorkPieceType> getStores() {
		if (stores == null) {
			stores = new EObjectResolvingEList<WorkPieceType>(WorkPieceType.class, this, ManufacturePackage.STORAGE__STORES);
		}
		return stores;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ManufacturePackage.STORAGE__STORES:
				return getStores();
		}
