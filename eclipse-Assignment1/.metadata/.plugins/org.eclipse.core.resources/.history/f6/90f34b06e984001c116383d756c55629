 ...
 * </p>
 * <ul>
 *   <li>{@link Manufacture.impl.ResponsibleImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResponsibleImpl extends MinimalEObjectImpl.Container implements Responsible {
	...
	protected EClass eStaticClass() {
		return ManufacturePackage.Literals.RESPONSIBLE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ManufacturePackage.RESPONSIBLE__NAME, oldName, name));
	}
