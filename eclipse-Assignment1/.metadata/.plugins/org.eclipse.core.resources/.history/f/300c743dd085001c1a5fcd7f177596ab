...
public class ManufactureAdapterFactory extends AdapterFactoryImpl {
	...
	protected ManufactureSwitch<Adapter> modelSwitch =
		new ManufactureSwitch<Adapter>() {
			...
			@Override
			public Adapter caseInputConditioner(InputConditioner object) {
				return createInputConditionerAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseOutPutWorkPiece(OutPutWorkPiece object) {
				return createOutPutWorkPieceAdapter();
			}
			@Override
			public Adapter caseInputWorkPiece(InputWorkPiece object) {
				return createInputWorkPieceAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link Manufacture.InputConditioner <em>Input Conditioner</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link Manufacture.Element <em>Element</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link Manufacture.Responsible <em>Responsible</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link Manufacture.WorkPieceType <em>Work Piece Type</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link Manufacture.OutPutWorkPiece <em>Out Put Work Piece</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link Manufacture.InputWorkPiece <em>Input Work Piece</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
